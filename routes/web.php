...
use App\Http\Controllers\Admin\AlbunsController;
use App\Http\Controllers\Admin\MusicasController;
use App\Http\Controllers\Admin\ComprasController;
use App\Http\Controllers\site\IndexController as Site;
...
Route::get('/index', [Site::class, 'index'])->name('index');

Route::get('/get-musicas-albuns', [MusicasController::class, 'getMusics']);

Route::post('/comprar', [Site::class, 'pucharse'])->name('comprar');

Route::prefix('/admin')->group(function(){
    Route::get('/', [IndexController::class, 'index'])->name('admin');
    
    Route::resource('albuns', AlbunsController::class);
